...
/**
 * Form primitives in the shadcn style.
 * Every form in the app composes from <Form>, <FormField>, <FormItem>,
 * <FormLabel>, <FormControl>, <FormDescription>, <FormMessage>.
 * Error rendering and accessibility wiring (aria-describedby, aria-invalid,
 * htmlFor) are uniform.
 */
